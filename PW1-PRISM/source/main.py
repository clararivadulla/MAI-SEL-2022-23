...
def print_rules(prism, train, test):
    num = 1
    for C_i in prism:
...
def rule_recall(C_i, rule, x):
    ...
    satisfies_all = satisfies_all.loc[satisfies_all['class'] == C_i] # instances satisfying the antecedent of R and the consequent of R
